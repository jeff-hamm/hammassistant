...
{
    public static bool SupportsColor(this ColorMode mode) => mode.HasFlag(ColorMode.IsColor);
    public static bool SupportsBrightness(this ColorMode mode) => mode.HasFlag(ColorMode.Brightness);
    public static bool SupportsColorTemp(this ColorMode mode) => mode == ColorMode.ColorTemp || mode.SupportsColor();
}
